...
dash.register_page(__name__, path="/unweighted-graphs")

layout = html.Div([
    html.H2("Unweighted Darkness Graphs"),
    dcc.Graph(id='unweighted-graph')  # you can plug in your real graph here
])
